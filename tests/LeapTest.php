...
class LeapTest extends PHPUnit_Framework_TestCase {
  ...
  public function testAssertLeapYear() {
    ...
    // 1395 is a leap year
    // $this->assertEquals( TRUE, Datium::create(2016, 3, 20, 0, 0, 0)->to( 'shamsi' )->leap('ir')->get() );
    //
    // // 1396 is not a leap year
    // $this->assertEquals( FALSE, Datium::create(2017, 3, 21, 0, 0, 0)->to( 'shamsi' )->leap('ir')->get() );
    //
    // // 1397 is not a leap year
    // $this->assertEquals( FALSE, Datium::create(2018, 3, 21, 0, 0, 0)->to('shamsi')->leap('ir')->get() );
    //
    // // 1398 is not a leap year
    // $this->assertEquals( FALSE, Datium::create(2019, 3, 21, 0, 0, 0)->to('shamsi')->leap('ir')->get() );
    //
    // // 1399 is a leap year
    // $this->assertEquals( TRUE, Datium::create(2020, 3, 20, 0, 0, 0)->to('shamsi')->leap('ir')->get() );
